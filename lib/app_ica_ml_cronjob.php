...
class app_ica_ml_cronjob extends app_ica_ml_models {
	...
	public function InsetPost() {
		...
		$melhtml = new app_ica_ml_helpers();
		$mellang = $melhtml -> class_lang;
		
		$posts = $this -> importUrl();
		
		foreach ($posts as $key => $value) {

			$parentname = $mellang[$key];
...
$opic_ica_ml_cronjob = new app_ica_ml_cronjob();
